...
$header_titulo = 'Últimas Notas de la comunidad';
...
<!--    <div class="g--10 m--1">
    ...
    <div class="g--10 m--1 container container--wrap--s">
      ...
      <!-- <div class="g--4 g-s--12 fade-in-from-top card">
        <h3>Super Tip</h3>
        <p>Comentar el código describiendo que es lo que hace, y cómo lo hace.</p>
      </div> -->
    </div>
